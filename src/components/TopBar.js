...
export const TopBar = ({ data, firstLetter, lastLetter }) => {
  return (
      ...
      <div className="top-bar-right">
        <nav className="secondary-navigation">
          <ul className="menu">
                  ...
                  <svg>
                    <use xlinkHref="#i-help">
                      ...
                      >
                        ...
                        <path
                          className="path1"
                          d="M9.345 25.085c-0.034-0.001-0.074-0.002-0.115-0.002-0.934 0-1.779 0.383-2.385 1.001-0.597 0.652-0.962 1.524-0.962 2.481s0.365 1.828 0.964 2.483c0.629 0.66 1.518 1.071 2.503 1.071 1.911 0 3.46-1.549 3.46-3.46 0-0.028 0-0.056-0.001-0.083 0.002-0.041 0.004-0.095 0.004-0.148 0-1.847-1.498-3.345-3.345-3.345-0.043 0-0.087 0.001-0.13 0.002zM16.845 2.195q-2.515-2.195-7.070-2.195t-7.12 2.31c-1.65 1.46-2.5 3.46-2.635 6v0 1.385h6.22v-0.97c-0.001-0.033-0.002-0.073-0.002-0.112 0-0.993 0.381-1.898 1.004-2.575 0.613-0.617 1.465-1 2.406-1 0.048 0 0.095 0.001 0.143 0.003q3.343 0 3.343 3.615c-0.001 0.844-0.241 1.631-0.656 2.299-0.736 1.052-1.59 1.974-2.555 2.767-1.153 0.959-2.058 2.128-2.674 3.458-0.493 1.369-0.764 2.879-0.764 4.451 0 0.172 0.003 0.343 0.010 0.514l5.499-0.025 0.085-1.415c0.17-1.459 0.855-2.733 1.866-3.656l1.735-1.644c1.122-1.019 2.072-2.202 2.818-3.515 0.55-1.059 0.852-2.23 0.852-3.47 0-0.012 0-0.024 0-0.037q0.005-3.998-2.505-6.188z"
                        />
                      </svg>
                    </use>
                  </svg>
            ...
            <li>
              <Link to="/login" className="nav-bar-avatar">
                <span className="avatar-initials ">
                  {Boolean(data) ? (
                    ...
                    <span className="avatar-initials-text">In</span>
                  )}
                </span>
              </Link>
            </li>
                  ...
                  <svg>
                    <use xlinkHref="#i-menu">
                      ...
                      >
                        ...
                        <path
                          className="path1"
                          d="M30.7 14.7h-29.4c-0.7 0-1.3 0.6-1.3 1.3s0.6 1.3 1.3 1.3h29.3c0.7 0 1.3-0.6 1.3-1.3s-0.5-1.3-1.2-1.3z"
                        />
                        <path
                          className="path2"
                          d="M1.3 8.4h29.3c0.7 0 1.3-0.6 1.3-1.3s-0.6-1.3-1.3-1.3h-29.3c-0.7 0-1.3 0.6-1.3 1.3s0.6 1.3 1.3 1.3z"
                        />
                        <path
                          className="path3"
                          d="M30.7 23.6h-29.4c-0.7 0-1.3 0.6-1.3 1.3s0.6 1.3 1.3 1.3h29.3c0.7 0 1.3-0.6 1.3-1.3 0.1-0.7-0.5-1.3-1.2-1.3z"
                        />
                      </svg>
                    </use>
                  </svg>
                  ...
                  <svg>
                    <use xlinkHref="#i-close">
                      ...
                      >
                        ...
                        <path
                          className="path1"
                          d="M16 11.68l-10.785-10.785c-0.558-0.548-1.323-0.886-2.167-0.886s-1.61 0.338-2.168 0.886c-0.546 0.558-0.883 1.323-0.883 2.167s0.337 1.609 0.884 2.168l10.799 10.769-10.785 10.785c-0.571 0.556-0.925 1.332-0.925 2.19 0 1.687 1.368 3.055 3.055 3.055 0.859 0 1.635-0.354 2.19-0.925l10.786-10.786 10.785 10.785c0.556 0.571 1.332 0.925 2.19 0.925 1.687 0 3.055-1.368 3.055-3.055 0-0.859-0.354-1.635-0.925-2.19l-10.786-10.786 10.785-10.785c0.548-0.558 0.886-1.323 0.886-2.167s-0.338-1.61-0.886-2.168c-0.558-0.546-1.323-0.883-2.167-0.883s-1.609 0.337-2.168 0.884z"
                        />
                      </svg>
                    </use>
                  </svg>
